    ...
    <main className="flex-1 flex flex-col items-center justify-center p-6 sm:p-12 text-center bg-[var(--bg-canvas)] text-[var(--text-main)] relative overflow-hidden font-sans">
      ...
      <div className="max-w-3xl w-full p-8 sm:p-12 rounded-3xl bg-[var(--bg-surface)] border border-[var(--border-subtle)] shadow-xl relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          <div className="p-5 rounded-2xl bg-[var(--bg-canvas)] border border-[var(--border-subtle)] hover:border-pale-sky-500/40 transition-colors">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-8">
          ...
          <button className="px-6 py-3 rounded-xl bg-[var(--bg-canvas)] border border-[var(--border-subtle)] text-[var(--text-main)] font-semibold hover:bg-pale-sky-100 dark:hover:bg-pale-sky-800 transition-all cursor-pointer">
            إضافة كتاب جديد
          </button>
        </div>
